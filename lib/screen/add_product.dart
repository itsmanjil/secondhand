...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  var countInStockController = TextEditingController(text: "");
  var ratingController = TextEditingController(text: "");
  var numReviewsController = TextEditingController(text: "");
                ...
                child: Column(
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(
                        labelText: 'Condion Rating',
                        hintText: 'Condion rating',
                        border: OutlineInputBorder(),
                      ),
                    ),
                    gap,
